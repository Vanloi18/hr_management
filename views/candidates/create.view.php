                ...
                <div class="card-header border-0 py-4 bg-success text-white" style="background: linear-gradient(135deg, #198754 0%, #20c997 100%);">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="mb-0 opacity-75 small">Nhập thông tin ứng viên và upload CV</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <h6 class="fw-bold text-uppercase text-secondary text-xs opacity-75 mb-3 ls-1">
                                    <i class="bi bi-person-vcard me-1"></i> Thông tin ứng viên
                                </h6>
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <h6 class="fw-bold text-uppercase text-secondary text-xs opacity-75 mb-3 ls-1">
                                    <i class="bi bi-briefcase me-1"></i> Thông tin ứng tuyển
                                </h6>
                                <div class="mb-3">
                                    <label class="form-label fw-medium">Vị trí ứng tuyển <span class="text-danger">*</span></label>
                                    <select name="position_id" class="form-select form-select-lg bg-light border-0 cursor-pointer" required>
                                        <option value="">-- Chọn vị trí --</option>
                                        <?php if(isset($positions) && is_array($positions)): ?>
                                            <?php foreach ($positions as $pos): ?>
                                                <option value="<?php echo $pos['id']; ?>" <?php echo ($old['position_id'] ?? '') == $pos['id'] ? 'selected' : ''; ?>>
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-medium">CV (PDF/DOC) <span class="text-danger">*</span></label>
                                    <input type="file" name="cv_file" class="form-control bg-light border-0" required>
                                    <div class="form-text small">Dung lượng tối đa 5MB.</div>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-medium">Ghi chú thêm</label>
                                    <textarea name="notes" rows="3" class="form-control bg-light border-0 rounded-3"><?php echo e($old['notes'] ?? ''); ?></textarea>
                                </div>
                            </div>
                        </div>

                        <div class="d-flex gap-2 justify-content-end mt-5">
                            <a href="<?php echo BASE_URL; ?>/candidates" class="btn btn-light btn-lg px-4 rounded-pill border-0 text-secondary">Hủy bỏ</a>
