                ...
                <div class="card-header border-0 py-4 bg-primary text-white">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="mb-0 opacity-75 small">Đang chỉnh sửa: <strong><?php echo e($position['title']); ?></strong></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                ...
                                <input type="text" name="title" class="form-control form-control-lg bg-light border-0" 
                                       value="<?php echo e($position['title']); ?>" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="recruiter_id" class="form-select form-select-lg bg-light border-0 cursor-pointer" required>
                                    <?php foreach ($recruiters as $rec): ?>
                                        <option value="<?php echo $rec['id']; ?>" <?php echo $position['recruiter_id'] == $rec['id'] ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="field_id" class="form-select form-select-lg bg-light border-0 cursor-pointer" required>
                                    <?php foreach ($fields as $field): ?>
                                        <option value="<?php echo $field['id']; ?>" <?php echo $position['field_id'] == $field['id'] ? 'selected' : ''; ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="salary_range" class="form-control form-control-lg bg-light border-0" 
                                       value="<?php echo e($position['salary_range'] ?? ''); ?>" placeholder="VD: 15 - 20 Triệu">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="location" class="form-control form-control-lg bg-light border-0" 
                                       value="<?php echo e($position['location'] ?? ''); ?>" placeholder="VD: Hà Nội">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label fw-medium">Trạng thái</label>
                                <select name="status" class="form-select form-select-lg bg-light border-0 cursor-pointer">
                                    <option value="open" <?php echo $position['status'] === 'open' ? 'selected' : ''; ?>>Đang tuyển (Open)</option>
                                    <option value="closed" <?php echo $position['status'] === 'closed' ? 'selected' : ''; ?>>Đã đóng (Closed)</option>
                                </select>
                            </div>

                            <div class="col-12">
                                <label class="form-label fw-medium">Mô tả công việc</label>
                                <textarea name="description" rows="4" class="form-control bg-light border-0 rounded-3"><?php echo e($position['description']); ?></textarea>
                            </div>

                            <div class="col-12">
                                <label class="form-label fw-medium">Yêu cầu</label>
                                <textarea name="requirements" rows="4" class="form-control bg-light border-0 rounded-3"><?php echo e($position['requirements']); ?></textarea>
                            </div>
                        </div>
