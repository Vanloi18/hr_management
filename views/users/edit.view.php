                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <form method="POST" action="<?php echo BASE_URL; ?>/users/update" class="needs-validation" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="alert alert-light border-0 rounded-3 d-flex align-items-center mb-3 py-2">
                                <i class="bi bi-info-circle text-info me-2"></i>
                                <span class="small text-muted">Chỉ nhập nếu muốn đổi mật khẩu mới.</span>
                            </div>
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="password" id="password" name="password" 
                                               class="form-control form-control-lg bg-light border-0 border-end-0" placeholder="••••••">
                        ...
                        <div class="d-flex gap-2 justify-content-end mt-5">
                            <a href="<?php echo BASE_URL; ?>/users" class="btn btn-light btn-lg px-4 rounded-pill border-0 text-secondary">Hủy bỏ</a>
...
<style>
    ...
    [data-theme="dark"] .alert-light { background-color: #2c2c2c; color: #ddd; }
</style>
